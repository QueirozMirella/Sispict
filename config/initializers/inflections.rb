...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  # Incontáveis
  inflect.uncountable %w[ tórax tênis ônibus lápis fênix projeto_geral ]

  # Irregulares
  inflect.irregular "país", "países"
  inflect.irregular 'plano_de_trabalho', 'planos_de_trabalho'
  inflect.irregular 'palavra_chave', 'palavras_chave'
  inflect.irregular 'declaracao_de_vinculo', 'declaracoes_de_vinculo'
  inflect.irregular 'ficha_cadastral', 'fichas_cadastral'
